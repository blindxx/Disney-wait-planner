...
export const TOM_HELP_SECTIONS: TomHelpSection[] = [
  ...
  },
  {
    ...
    examples: [
      "Where is Radiator Springs Racers?",
      "What land is Mr. Toad's Wild Ride in?",
      "Where is Guardians of the Galaxy: Cosmic Rewind?",
      "What land is Savi's Workshop in?",
    ],
    chipIcon: "🗺️",
  },
  {
  ...
  },
  {
    ...
    examples: ["Tell me about Expedition Everest.", "Tell me about Rise of the Resistance."],
    chipIcon: "🎢",
  },
  {
    id: "wait-times",
  ...
  },
  {
    ...
    title: "Dining",
    icon: "🍽️",
    paragraphs: ["Ask about Disney dining options and specific restaurants."],
  ...
  },
  {
    ...
    examples: [
      ...
      "What does Disney California Adventure do for the holidays?",
    ],
    chipIcon: "🎆",
  },
  {

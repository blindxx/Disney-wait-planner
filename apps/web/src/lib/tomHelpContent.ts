...
export const TOM_HELP_SECTIONS: TomHelpSection[] = [
  ...
  },
  {
    ...
    icon: "📊",
    paragraphs: [
      "Tom can look across your itinerary to answer higher-level questions, like which day has the most or fewest items planned, what's first or last on a given day, or your earliest or latest activity overall — where your planner has enough detail to support it. Results depend on how much you've entered and may vary as your plans change.",
      ...
      "Tom can also tell you what's immediately before or after an activity you name explicitly, like a specific attraction, show, or reservation — not general moments like \"after lunch\" or \"in the evening\", since those aren't real planner items. If a name matches more than one saved item — for example, the same attraction saved on two different days — Tom will ask which one you mean rather than guess.",
      "If you've given a day a custom name, Tom uses it naturally in answers, and \"Day 2\"-style references still work the same way. Today/tomorrow questions only work when your planner days have real dates attached — without them, Tom will let you know rather than guess. Tom also tolerates common typos and small misspellings in planner item and park names, matching them to your saved data where the match is reasonably clear.",
    ],
    examples: [
      ...
      "What's planned on EPCOT Day?",
      "What park is Arrival Day?",
    ],
    chipIcon: "📊",
  },
  {
